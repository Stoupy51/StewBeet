...
scoreboard players add #total_raw_super_iron_block your_namespace.data 0
scoreboard players add #total_deepslate_super_iron_ore your_namespace.data 0
scoreboard players add #total_super_iron_ore your_namespace.data 0
scoreboard players add #total_super_iron_block your_namespace.data 0
tellraw @s [{"translate":"your_namespace.total_super_iron_block","color":"gold"},{"score":{"name":"#total_super_iron_block","objective":"your_namespace.data"},"color":"yellow"}]
tellraw @s [{"translate":"your_namespace.total_super_iron_ore","color":"gold"},{"score":{"name":"#total_super_iron_ore","objective":"your_namespace.data"},"color":"yellow"}]
tellraw @s [{"translate":"your_namespace.total_deepslate_super_iron_ore","color":"gold"},{"score":{"name":"#total_deepslate_super_iron_ore","objective":"your_namespace.data"},"color":"yellow"}]
tellraw @s [{"translate":"your_namespace.total_raw_super_iron_block","color":"gold"},{"score":{"name":"#total_raw_super_iron_block","objective":"your_namespace.data"},"color":"yellow"}]
