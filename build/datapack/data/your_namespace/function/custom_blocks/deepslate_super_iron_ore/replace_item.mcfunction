...
#> your_namespace:custom_blocks/deepslate_super_iron_ore/replace_item
#
# @within	your_namespace:custom_blocks/deepslate_super_iron_ore/destroy
#

# If silk touch applied
execute if score #is_silk_touch your_namespace.data matches 1 run data modify entity @s Item.id set from storage your_namespace:items all.deepslate_super_iron_ore.id
execute if score #is_silk_touch your_namespace.data matches 1 run data modify entity @s Item.components set from storage your_namespace:items all.deepslate_super_iron_ore.components
