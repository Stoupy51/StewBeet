...
execute if score #dependency_error your_namespace.data matches 0 if score #smithed.custom_block.major load.status matches 0 unless score #smithed.custom_block.minor load.status matches 7.. run scoreboard players set #dependency_error your_namespace.data 1
...
execute if score #dependency_error your_namespace.data matches 0 if score #smithed.crafter.major load.status matches 0 unless score #smithed.crafter.minor load.status matches 7.. run scoreboard players set #dependency_error your_namespace.data 1
...
execute if score #dependency_error your_namespace.data matches 0 unless score $bs.math.major load.status matches 3.. run scoreboard players set #dependency_error your_namespace.data 1
execute if score #dependency_error your_namespace.data matches 0 if score $bs.math.major load.status matches 3 unless score $bs.math.minor load.status matches 0.. run scoreboard players set #dependency_error your_namespace.data 1
execute if score #dependency_error your_namespace.data matches 0 if score $bs.math.major load.status matches 3 if score $bs.math.minor load.status matches 0 unless score $bs.math.patch load.status matches 2.. run scoreboard players set #dependency_error your_namespace.data 1
