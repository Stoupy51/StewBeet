...
execute if score #dependency_error your_namespace.data matches 0 if score #common_signals.major load.status matches 0 if score #common_signals.minor load.status matches 0 unless score #common_signals.patch load.status matches 5.. run scoreboard players set #dependency_error your_namespace.data 1
...
execute if score #dependency_error your_namespace.data matches 0 if score #furnace_nbt_recipes.major load.status matches 1 unless score #furnace_nbt_recipes.minor load.status matches 7.. run scoreboard players set #dependency_error your_namespace.data 1
...
execute if score #dependency_error your_namespace.data matches 0 if score #smart_ore_generation.major load.status matches 1 unless score #smart_ore_generation.minor load.status matches 6.. run scoreboard players set #dependency_error your_namespace.data 1
