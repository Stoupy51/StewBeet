...
📄 **Code source** : [stewbeet/core/utils/equation.py](https://github.com/Stoupy51/StewBeet/blob/main/python_package/stewbeet/core/utils/equation.py) 🔗<br>
...
Depuis le [template extensive](https://github.com/Stoupy51/StewBeet/blob/main/templates/extensive/src/link.py) :
```python
