...
<img src="https://raw.githubusercontent.com/Stoupy51/StewBeet/main/docs/plugins/img/datapack.loot_tables.complete_file_tree.jpg">

**Function to give all items (comfortably stored in named chests):**<br>
<img src="https://raw.githubusercontent.com/Stoupy51/StewBeet/main/docs/plugins/img/datapack.loot_tables.give_all.jpg">

**Source Code**: [`stewbeet/plugins/datapack/loot_tables/__init__.py`](https://github.com/Stoupy51/StewBeet/blob/main/python_package/stewbeet/plugins/datapack/loot_tables/__init__.py)
