...
<img src="https://raw.githubusercontent.com/Stoupy51/StewBeet/main/docs/plugins/img/initialize.source_lore.jpg" style="width: min(540px, 100%)">

**Automatic pack.mcmeta + Automatic description (If not configured)**<br>
<img src="https://raw.githubusercontent.com/Stoupy51/StewBeet/main/docs/plugins/img/initialize.pack_mcmeta.jpg" style="width: min(540px, 100%)">

**Legacy Texture Naming Conversion**<br>
<img src="https://raw.githubusercontent.com/Stoupy51/StewBeet/main/docs/plugins/img/initialize.legacy_texture_naming.jpg" style="width: min(540px, 100%)">

**Source Code**: [`stewbeet/plugins/initialize/__init__.py`](https://github.com/Stoupy51/StewBeet/blob/main/python_package/stewbeet/plugins/initialize/__init__.py) <br>  
**Source Code**: [`stewbeet/plugins/initialize/source_lore_font.py`](https://github.com/Stoupy51/StewBeet/blob/main/python_package/stewbeet/plugins/initialize/source_lore_font.py) <br>


## What it does

- Initializes the StewBeet framework
- Sets up more project metadata and configurations
...
- Creates source lore fonts for item identification
