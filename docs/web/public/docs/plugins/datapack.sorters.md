...
**Source Code**: [`stewbeet/plugins/datapack/sorters/__init__.py`](https://github.com/Stoupy51/StewBeet/blob/main/python_package/stewbeet/plugins/datapack/sorters/__init__.py) <br>  
**Source Code**: [`stewbeet/plugins/datapack/sorters/constants.py`](https://github.com/Stoupy51/StewBeet/blob/main/python_package/stewbeet/plugins/datapack/sorters/constants.py) <br>  
**Source Code**: [`stewbeet/plugins/datapack/sorters/extend_datapack.py`](https://github.com/Stoupy51/StewBeet/blob/main/python_package/stewbeet/plugins/datapack/sorters/extend_datapack.py) <br>  
**Source Code**: [`stewbeet/plugins/datapack/sorters/match.py`](https://github.com/Stoupy51/StewBeet/blob/main/python_package/stewbeet/plugins/datapack/sorters/match.py) <br>  
**Source Code**: [`stewbeet/plugins/datapack/sorters/quick_sort.py`](https://github.com/Stoupy51/StewBeet/blob/main/python_package/stewbeet/plugins/datapack/sorters/quick_sort.py) <br>  
**Source Code**: [`stewbeet/plugins/datapack/sorters/selection_sort.py`](https://github.com/Stoupy51/StewBeet/blob/main/python_package/stewbeet/plugins/datapack/sorters/selection_sort.py) <br>
...
<img src="https://raw.githubusercontent.com/Stoupy51/StewBeet/main/docs/plugins/img/datapack.sorters.registry.jpg">

**Alternatively, they can be generated with python:**<br>
<img src="https://raw.githubusercontent.com/Stoupy51/StewBeet/main/docs/plugins/img/datapack.sorters.generate_sort.jpg">

**The list can now be sorted:**<br>
<img src="https://raw.githubusercontent.com/Stoupy51/StewBeet/main/docs/plugins/img/datapack.sorters.mcfunction.jpg">
...
```
- Anywhere in your workspace, create `sorter.mcdoc`: [stewbeet/plugins/datapack/sorters/mod.mcdoc](https://github.com/Stoupy51/StewBeet/blob/main/python_package/stewbeet/plugins/datapack/sorters/mod.mcdoc) 🔗<br>
