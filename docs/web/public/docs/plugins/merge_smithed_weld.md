...
<img src="https://raw.githubusercontent.com/Stoupy51/StewBeet/main/docs/plugins/img/merged_smithed_weld.output_directory.jpg">

**We can see inside the datapack all namespaces**<br>
<img src="https://raw.githubusercontent.com/Stoupy51/StewBeet/main/docs/plugins/img/merged_smithed_weld.inside_datapack.jpg">
...
**Source Code**: [`stewbeet/plugins/merge_smithed_weld/__init__.py`](https://github.com/Stoupy51/StewBeet/blob/main/python_package/stewbeet/plugins/merge_smithed_weld/__init__.py) <br>  
**Source Code**: [`stewbeet/plugins/merge_smithed_weld/weld.py`](https://github.com/Stoupy51/StewBeet/blob/main/python_package/stewbeet/plugins/merge_smithed_weld/weld.py) <br>  
**Source Code**: [`stewbeet/plugins/merge_smithed_weld/datapack.py`](https://github.com/Stoupy51/StewBeet/blob/main/python_package/stewbeet/plugins/merge_smithed_weld/datapack/__init__.py) <br>  
**Source Code**: [`stewbeet/plugins/merge_smithed_weld/resource_pack.py`](https://github.com/Stoupy51/StewBeet/blob/main/python_package/stewbeet/plugins/merge_smithed_weld/resource_pack/__init__.py) <br>
...
- Integrates used official libraries automatically
- Handles proper pack.mcmeta and pack.png preservation
