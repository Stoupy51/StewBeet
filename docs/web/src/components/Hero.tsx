        ...
        <section ref={containerRef} id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 bg-[#0a0a0a]">
            ...
            <div className="relative z-10 w-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                >
                    ...
                    >
                        StewBeet is a <a href="https://github.com/mcbeet/beet" target="_blank" rel="noopener noreferrer" className="text-indigo-400 hover:text-indigo-300 transition-colors">Beet</a> framework providing powerful automation for Minecraft datapacks. Adaptable to any workflow—use only the features you need, or leverage the full suite for complete project generation.
                    </motion.p>
                    ...
                    >
                        <div className="flex items-center gap-2">
                            ...
                            <span>Type-safe definitions</span>
                        </div>
                        <div className="flex items-center gap-2">
                            <HiCheck className="text-indigo-400" />
                            <span>Auto-generated assets</span>
                        </div>
                    </motion.div>
                </motion.div>
