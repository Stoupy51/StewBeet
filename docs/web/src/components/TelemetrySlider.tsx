        ...
        <section className="max-w-3xl mx-auto">
            <div className="flex items-center gap-2">
                <button
                    ...
                    className="flex-shrink-0 rounded-control border border-ink-800 p-2 text-ink-300 transition-colors hover:border-ink-50/25 hover:text-ink-50 disabled:opacity-30 disabled:hover:border-ink-800 disabled:hover:text-ink-300"
                >
                    ...
                    {TELEMETRY_STREAMS.map((stream, position) => (
                        <button
                            ...
                            className={`flex-shrink-0 rounded-control border px-3 py-1.5 text-sm transition-colors ${
                                position === index ? TOGGLE_ACTIVE : 'border-ink-800 text-ink-400 hover:border-ink-50/25 hover:text-ink-200'
                            }`}
                        >
