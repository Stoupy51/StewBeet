...
const getPlugins = (t: (key: string) => string): Plugin[] => [
    ...
    { id: 2, name: 'verify_definitions', category: t('pluginsTable.categoryCore'), descriptionKey: 'pluginsTable.verifyDefinitionsDesc', color: 'from-green-500 to-emerald-500', icon: HiCheckCircle, dependency: '🔴', delay: 0.05, link: 'https://github.com/Stoupy51/StewBeet/blob/main/docs/plugins/verify_definitions.md', image: 'https://raw.githubusercontent.com/Stoupy51/StewBeet/main/docs/plugins/img/verify_definitions.json_dump.jpg' },

    // Resource Pack
    { id: 3, name: 'resource_pack.sounds', category: t('pluginsTable.categoryResourcePack'), descriptionKey: 'pluginsTable.soundsDesc', color: 'from-purple-500 to-pink-500', icon: HiVolumeUp, dependency: '🟡', delay: 0.1, link: 'https://github.com/Stoupy51/StewBeet/blob/main/docs/plugins/resource_pack.sounds.md', image: 'https://raw.githubusercontent.com/Stoupy51/StewBeet/main/docs/plugins/img/resource_pack.sounds.result.jpg' },
    { id: 4, name: 'resource_pack.item_models', category: t('pluginsTable.categoryResourcePack'), descriptionKey: 'pluginsTable.itemModelsDesc', color: 'from-blue-500 to-cyan-500', icon: HiColorSwatch, dependency: '🟡', delay: 0.15, link: 'https://github.com/Stoupy51/StewBeet/blob/main/docs/plugins/resource_pack.item_models.md', image: 'https://raw.githubusercontent.com/Stoupy51/StewBeet/main/docs/plugins/img/resource_pack.item_models.pattern_detection.jpg' },
    ...
    { id: 6, name: 'custom_recipes', category: t('pluginsTable.categoryRecipes'), descriptionKey: 'pluginsTable.customRecipesDesc', color: 'from-orange-500 to-red-500', icon: HiBeaker, dependency: '🔴', delay: 0.25, link: 'https://github.com/Stoupy51/StewBeet/blob/main/docs/plugins/custom_recipes.md', image: 'https://raw.githubusercontent.com/Stoupy51/StewBeet/main/docs/plugins/img/custom_recipes.smithed_recipe.jpg' },
    { id: 7, name: 'custom_paintings', category: t('pluginsTable.categoryCustomContent'), descriptionKey: 'pluginsTable.customPaintingsDesc', color: 'from-pink-500 to-rose-500', icon: HiPhotograph, dependency: '🔴', delay: 0.3, link: 'https://github.com/Stoupy51/StewBeet/blob/main/docs/plugins/custom_paintings.md', image: 'https://raw.githubusercontent.com/Stoupy51/StewBeet/main/docs/plugins/img/custom_paintings.placed_painting.jpg' },

    // Documentation
    { id: 8, name: 'ingame_manual', category: t('pluginsTable.categoryDocumentation'), descriptionKey: 'pluginsTable.ingameManualDesc', color: 'from-amber-500 to-yellow-500', icon: HiBookOpen, dependency: '🔴', delay: 0.35, link: 'https://github.com/Stoupy51/StewBeet/blob/main/docs/plugins/ingame_manual.md', image: 'https://i.imgur.com/dtuAG99.gif' },

    // Datapack
    { id: 9, name: 'datapack.loading', category: t('pluginsTable.categoryDatapack'), descriptionKey: 'pluginsTable.loadingDesc', color: 'from-cyan-500 to-blue-500', icon: HiLightningBolt, dependency: '🟡', delay: 0.4, link: 'https://github.com/Stoupy51/StewBeet/blob/main/docs/plugins/datapack.loading.md', image: 'https://raw.githubusercontent.com/Stoupy51/StewBeet/main/docs/plugins/img/datapack.loading.load_messages.jpg' },
    { id: 10, name: 'datapack.custom_blocks', category: t('pluginsTable.categoryDatapack'), descriptionKey: 'pluginsTable.customBlocksDesc', color: 'from-teal-500 to-emerald-500', icon: HiCube, dependency: '🔴', delay: 0.45, link: 'https://github.com/Stoupy51/StewBeet/blob/main/docs/plugins/datapack.custom_blocks.md', image: 'https://raw.githubusercontent.com/Stoupy51/StewBeet/main/docs/plugins/img/datapack.custom_blocks.stats.jpg' },
    ...
    { id: 12, name: 'datapack.sorters', category: t('pluginsTable.categoryDatapack'), descriptionKey: 'pluginsTable.sortersDesc', color: 'from-violet-500 to-purple-500', icon: HiSortAscending, dependency: '🟢', delay: 0.55, link: 'https://github.com/Stoupy51/StewBeet/blob/main/docs/plugins/datapack.sorters.md', image: 'https://raw.githubusercontent.com/Stoupy51/StewBeet/main/docs/plugins/img/datapack.sorters.registry.jpg' },
    ...
    // Build
    { id: 19, name: 'archive', category: t('pluginsTable.categoryBuild'), descriptionKey: 'pluginsTable.archiveDesc', color: 'from-gray-500 to-slate-500', icon: HiArchive, dependency: '🟢', delay: 0.9, link: 'https://github.com/Stoupy51/StewBeet/blob/main/docs/plugins/archive.md', image: 'https://raw.githubusercontent.com/Stoupy51/StewBeet/main/docs/plugins/img/archive.output_directory.jpg' },
    { id: 20, name: 'merge_smithed_weld', category: t('pluginsTable.categoryBuild'), descriptionKey: 'pluginsTable.mergeSmithedWeldDesc', color: 'from-indigo-500 to-blue-500', icon: HiLink, dependency: '🟢', delay: 0.95, link: 'https://github.com/Stoupy51/StewBeet/blob/main/docs/plugins/merge_smithed_weld.md', image: 'https://raw.githubusercontent.com/Stoupy51/StewBeet/main/docs/plugins/img/merged_smithed_weld.output_directory.jpg' },
    { id: 21, name: 'copy_to_destination', category: t('pluginsTable.categoryBuild'), descriptionKey: 'pluginsTable.copyToDestinationDesc', color: 'from-cyan-500 to-teal-500', icon: HiFolderOpen, dependency: '🟢', delay: 1.0, link: 'https://github.com/Stoupy51/StewBeet/blob/main/docs/plugins/copy_to_destination.md', image: 'https://raw.githubusercontent.com/Stoupy51/StewBeet/main/docs/plugins/img/copy_to_destination.datapack_destination.jpg' },
    { id: 22, name: 'compute_sha1', category: t('pluginsTable.categoryBuild'), descriptionKey: 'pluginsTable.computeSha1Desc', color: 'from-green-500 to-emerald-500', icon: HiShieldCheck, dependency: '🟢', delay: 1.05, link: 'https://github.com/Stoupy51/StewBeet/blob/main/docs/plugins/compute_sha1.md', image: 'https://raw.githubusercontent.com/Stoupy51/StewBeet/main/docs/plugins/img/compute_sha1.example.jpg' },
];
