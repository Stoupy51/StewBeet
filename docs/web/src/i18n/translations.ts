...
export const translations = {
    en: {
        ...
        documentation: {
            ...
            equations: 'Equations',
            equationsDesc: 'Build complex scoreboard arithmetic with chainable ScoreboardEquation and StorageEquation builders',
            dependencies: 'Datapack Library Support',
            dependenciesDesc: 'Auto-detect and download official libraries, declare custom dependencies, and generate runtime version checks',
    ...
    fr: {
        ...
        documentation: {
            ...
            equations: 'Équations',
            equationsDesc: 'Construisez des arithmétiques de scoreboard complexes avec les constructeurs chaînables ScoreboardEquation et StorageEquation',
            dependencies: 'Support des Bibliothèques de Datapack',
            dependenciesDesc: 'Détectez et téléchargez automatiquement les bibliothèques officielles, déclarez des dépendances personnalisées et générez des vérifications de version au runtime',
