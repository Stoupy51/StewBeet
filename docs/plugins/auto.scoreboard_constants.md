...
📄 **Source Code**: [`stewbeet/plugins/auto/scoreboard_constants/__init__.py`](../../python_package/stewbeet/plugins/auto/scoreboard_constants/__init__.py) 🔗<br>
...
<img src="img/auto.scoreboard_constants.example.jpg">
