...
# 🚀 Continuous Delivery with StewBeet
...
📄 **Source Code**: [stewbeet/continuous_delivery/](../../python_package/stewbeet/continuous_delivery/) 🔗<br>
...
- ⚙️ Register a new version on Smithed linking to the GitHub release assets
