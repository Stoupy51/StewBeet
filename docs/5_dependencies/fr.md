...
## 🧪 Exemples
📄 **Référence de configuration** : [extensive/beet.yml](../../templates/extensive/beet.yml) 🔗<br>
📄 **Exemple réel** : [SimplEnergy/beet.yml](https://github.com/Stoupy51/SimplEnergy/blob/main/beet.yml) 🔗<br>
📄 **Code source** : [stewbeet/plugins/finalyze/dependencies/__init__.py](../../python_package/stewbeet/plugins/finalyze/dependencies/__init__.py) 🔗<br>
