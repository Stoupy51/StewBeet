...
# 📦 StewBeet Datapack Library Support
...
## 🧪 Examples
📄 **Config Reference**: [extensive/beet.yml](../../templates/extensive/beet.yml) 🔗<br>
...
- ⚙️ Declare custom dependencies in `beet.yml` with `load_dependencies`
