...
#> _your_namespace:custom_blocks/vb_no_facing/destroy
#
...
execute as @n[type=item, nbt={Item: {id: "minecraft:cobblestone"}}, distance=..1] run function _your_namespace:custom_blocks/vb_no_facing/replace_item
...
scoreboard players remove #total_vb_no_facing _your_namespace.data 1
