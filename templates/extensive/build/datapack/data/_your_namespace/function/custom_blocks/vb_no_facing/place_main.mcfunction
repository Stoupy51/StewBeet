...
#> _your_namespace:custom_blocks/vb_no_facing/place_main
#
...
execute align xyz positioned ~0.5 ~0.5 ~0.5 summon item_display at @s run function _your_namespace:custom_blocks/vb_no_facing/place_secondary
...
scoreboard players add #total_vb_no_facing _your_namespace.data 1
