...
#> _your_namespace:custom_blocks/vb_block_facing/destroy
#
...
execute as @n[type=item, nbt={Item: {id: "minecraft:furnace"}}, distance=..1] run function _your_namespace:custom_blocks/vb_block_facing/replace_item
...
scoreboard players remove #total_vb_block_facing _your_namespace.data 1
