...
#> _your_namespace:custom_blocks/vb_contents_frame/place_main
#
# @executed	as @e[type=item_frame,tag=...] & at @s
#
# @within	_your_namespace:custom_blocks/vb_contents_frame/search [ as @e[type=item_frame,tag=...] & at @s ]
#

# Get the facing direction of the item frame
scoreboard players set #item_frame_facing _your_namespace.data 1
execute if entity @s[type=item_frame] run function _your_namespace:custom_blocks/vb_contents_frame/get_facing
...
execute as @n[tag=_your_namespace.new] at @s run function _your_namespace:custom_blocks/vb_contents_frame/place_secondary
...
scoreboard players add #total_vb_contents_frame _your_namespace.data 1
