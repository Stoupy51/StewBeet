...
execute if score #dimension smart_ore_generation.data matches 0.. if predicate {condition:"minecraft:random_chance",chance:0.20000} run function _your_namespace:calls/smart_ore_generation/veins/steel_ore
...
execute if score #dimension smart_ore_generation.data matches 0.. if predicate {condition:"minecraft:random_chance",chance:0.20000} run function _your_namespace:calls/smart_ore_generation/veins/deepslate_steel_ore_0
...
execute if score #dimension smart_ore_generation.data matches 0.. run function _your_namespace:calls/smart_ore_generation/veins/deepslate_steel_ore_1
execute if score #dimension smart_ore_generation.data matches 0.. run function _your_namespace:calls/smart_ore_generation/veins/deepslate_steel_ore_1
execute if score #dimension smart_ore_generation.data matches 0.. if predicate {condition:"minecraft:random_chance",chance:0.60000} run function _your_namespace:calls/smart_ore_generation/veins/deepslate_steel_ore_1
