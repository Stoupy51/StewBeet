...
execute if score #dimension smart_ore_generation.data matches 0.. run function _your_namespace:calls/smart_ore_generation/veins/steel_ore_0
execute if score #dimension smart_ore_generation.data matches 0.. if predicate {type: "minecraft:random_chance", chance: 0.2d} run function _your_namespace:calls/smart_ore_generation/veins/steel_ore_0

# Generate Steel Ore (x2)
scoreboard players set #dimension smart_ore_generation.data -1
execute if dimension minecraft:overworld run scoreboard players set #dimension smart_ore_generation.data 0
scoreboard players set #min_height smart_ore_generation.data 60
scoreboard players set #max_height smart_ore_generation.data 120
execute if score #dimension smart_ore_generation.data matches 0.. run function _your_namespace:calls/smart_ore_generation/veins/steel_ore_1
execute if score #dimension smart_ore_generation.data matches 0.. run function _your_namespace:calls/smart_ore_generation/veins/steel_ore_1
...
execute if score #dimension smart_ore_generation.data matches 0.. run function _your_namespace:calls/smart_ore_generation/veins/deepslate_steel_ore_1
execute if score #dimension smart_ore_generation.data matches 0.. run function _your_namespace:calls/smart_ore_generation/veins/deepslate_steel_ore_1
execute if score #dimension smart_ore_generation.data matches 0.. if predicate {type: "minecraft:random_chance", chance: 0.6d} run function _your_namespace:calls/smart_ore_generation/veins/deepslate_steel_ore_1
