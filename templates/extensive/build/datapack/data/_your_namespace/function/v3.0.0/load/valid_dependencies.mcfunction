...
execute if score #dependency_error _your_namespace.data matches 1 unless score #common_signals.major load.status matches 0.. run tellraw @a {"translate": "_your_namespace.common_signals_v0_2_0","color":"gold","click_event":{"action":"open_url","url":"https://github.com/Stoupy51/CommonSignals"}}
execute if score #dependency_error _your_namespace.data matches 1 if score #common_signals.major load.status matches 0 unless score #common_signals.minor load.status matches 2.. run tellraw @a {"translate": "_your_namespace.common_signals_v0_2_0","color":"gold","click_event":{"action":"open_url","url":"https://github.com/Stoupy51/CommonSignals"}}
...
execute if score #dependency_error _your_namespace.data matches 1 unless score #furnace_nbt_recipes.major load.status matches 1.. run tellraw @a {"translate": "_your_namespace.furnace_nbt_recipes_v1_10_1","color":"gold","click_event":{"action":"open_url","url":"https://github.com/Stoupy51/FurnaceNbtRecipes"}}
execute if score #dependency_error _your_namespace.data matches 1 if score #furnace_nbt_recipes.major load.status matches 1 unless score #furnace_nbt_recipes.minor load.status matches 10.. run tellraw @a {"translate": "_your_namespace.furnace_nbt_recipes_v1_10_1","color":"gold","click_event":{"action":"open_url","url":"https://github.com/Stoupy51/FurnaceNbtRecipes"}}
...
execute if score #dependency_error _your_namespace.data matches 1 unless score $bs.math.major load.status matches 3.. run tellraw @a {"translate": "_your_namespace.bookshelf_math_v3_2_0","color":"gold","click_event":{"action":"open_url","url":"https://github.com/mcbookshelf/bookshelf/releases"}}
execute if score #dependency_error _your_namespace.data matches 1 if score $bs.math.major load.status matches 3 unless score $bs.math.minor load.status matches 2.. run tellraw @a {"translate": "_your_namespace.bookshelf_math_v3_2_0","color":"gold","click_event":{"action":"open_url","url":"https://github.com/mcbookshelf/bookshelf/releases"}}
