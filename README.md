...
- ⚙️ Automatic special compatibilities with datapacks such as [`SimpleDrawer's compacted drawer`](https://edayot.github.io/SimpleDrawer/material.html), [`SimplEnergy's pulverizer`](./build/datapack/data/your_namespace/function/calls/simplenergy/pulverizer_recipes.mcfunction), and [`NeoEnchant's veinminer`](https://modrinth.com/datapack/neoenchant) for custom ores.
...
[![Star History Chart](https://api.star-history.com/chart?repos=Stoupy51/StewBeet&type=date&legend=top-left)](https://www.star-history.com/?repos=Stoupy51%2FStewBeet&type=date&legend=top-left)
