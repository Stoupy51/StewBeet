...
[![YouTube](https://img.shields.io/badge/YouTube-Watch-red?logo=youtube&logoColor=white)](https://www.youtube.com/watch?v=zkcQn23DRaw)
...
New to beet? beet, bolt and mecha are made by the beet team, StewBeet is a separate project that runs inside beet:

<picture>
  <source media="(prefers-color-scheme: light)" srcset="docs/web/public/img/stack/stewbeet-stack.en.light.svg">
  <img alt="beet runs the build and bolt and mecha plug into it, all three made by the beet team. StewBeet is a separate project that runs inside beet as plugins." src="docs/web/public/img/stack/stewbeet-stack.en.dark.svg">
</picture>

`Example of the in-game manual generated by StewBeet:`<br>
![In-game Manual Example](https://raw.githubusercontent.com/Stoupy51/StewBeet/refs/heads/main/docs/plugins/img/ingame_manual.gif)
...
- 📖 Automatic generation of a really [advanced and interactive items `manual`](./docs/plugins/img/ingame_manual.gif).
...
- 🖼️ `render` key on any text component: `{"render":"steel_ingot"}` in an item lore, a `tellraw` or the `source_lore` becomes an image of that item, drawn with a font generated for you (vanilla items and items from other packs included). Pictures too big for a single glyph are cut into a grid of them and put back together with negative spacing.
...
- ⚙️ Automatic special compatibilities with datapacks such as [`SimpleDrawer's compacted drawer`](https://edayot.github.io/SimpleDrawer/material.html), [`SimplEnergy's pulverizer`](./templates/extensive/build/datapack/data/_your_namespace/function/calls/simplenergy/pulverizer_recipes.mcfunction), and [`NeoEnchant's veinminer`](https://modrinth.com/datapack/neoenchant) for custom ores.
...
- Libraries or tools:
  - https://github.com/Stoupy51/RealisticExplosion
  - https://github.com/Stoupy51/SmartOreGeneration
  - https://github.com/Stoupy51/FurnaceNbtRecipes
  - https://github.com/Stoupy51/CommonSignals
  - https://github.com/Stoupy51/ShoppingKart
  - https://github.com/Stoupy51/SheepWars
  - https://github.com/Stoupy51/GolfBall
