...
def beet_default(ctx: Context):
    ...
    sounds_raw: str = ctx.assets[ns].extra["sounds.json"].get_content()
    sounds_data: JsonDict = json.loads(sounds_raw)
    ...
    fireselect_entry: JsonDict = sounds_data["fireselect"]
