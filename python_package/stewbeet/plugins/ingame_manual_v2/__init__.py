"""ingame_manual_v2 — modern, extensible, dialog-first in-game manual generator.

Opt in by replacing ``stewbeet.plugins.ingame_manual`` with ``stewbeet.plugins.ingame_manual_v2``
